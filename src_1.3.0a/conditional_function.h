...
double MetaAnalysis(vector<vector<vector<double> > > &z_score, vector<vector<vector<double> > > &beta_, vector<vector<double> > &sd, int x, mat & Res_fixed, mat &Res_random, string meta_mode, string output, vector<string>  &variant, map<string, bool> &pos,map<string, string> &GWAS_file, map<string, double > &MAF,string gene,vector<double> &test1_1,vector<double> &test2_1, vector<double> &test3_1, map<string, string> &ALLELE, bool write_cor, int minimum_tissue, bool Han);

double MetaAnalysis(vector<vector<vector<double> > > &z_score, vector<vector<vector<double> > > &beta_, vector<vector<double> > &sd, int x, mat & Res_fixed, mat &Res_random, string meta_mode, string output, vector<string>  &variant, map<string, bool> &pos,map<string, string> &GWAS_file, map<string, double > &MAF,string gene, bool INDEX, bool finemap, map<string, string> &ALLELE, string cor_file, bool write_cor, int minimum_tissue, bool Han);
...
double ConstructCovRandom(vector<vector<vector<double> > > &z_score, vector<vector<vector<double> > > &beta_, vector<vector<double> > &sd, int x, mat & Res_fixed, mat &Res_random , string output, vector<vector<string> >  &variant, map<string, bool> &pos, map<string, bool> &pos1, map <string, vector<double>> &Res, map<string, double> &MAF, vector<double> &VARIANCE, map<int,bool> &data_index, vector<double> &test1_1,vector<double> &test2_1, vector<double> &test3_1, map<string, string> & ALLELE, string cor_file, bool write_cor, int minimum_tissue, bool Han);
