             ...
             if(!test_only)
              {
               ...
               MM_conditional_analysis(y,gene, totalCausalSNP,rho, histFlag, gamma,weight, nthread,covariate_, grm_file_,outputFileName, Geno_file_, meta_mode, allele_file_, pos, colocal, gwas_file_, MAF, data_index, nested, finemap,p_cutoff, cis_summary,cor_file, causal);
...
//Prepare_input(string input_1_causal, string geno_file_1_causal, string gene, string anno, string input_1, vector<string> &allele_file_,vector<string> &y,map<string, bool> &pos, map<int, bool> &data_index,int colocal, bool finemap, int cis_length, int cov_length, vector<string> covariate_1, int LD_index);
               ...
               string cor_file_1=outputFileName+string("_peak_1_statistical_signal_summary_correlation");
                ...
                MM_conditional_analysis(y_1,gene, totalCausalSNP,rho, histFlag, gamma,weight, nthread,covariate_1, grm_file_1,outputFileName, Geno_file_, meta_mode, allele_file_1, pos, colocal, gwas_file_, MAF, data_index, nested, finemap,p_cutoff, cis_summary,cor_file_1, causal_1);
...
//                }
               ...
               MM_conditional_analysis(y_1,gene, totalCausalSNP,rho, histFlag, gamma,weight, nthread,covariate_2, grm_file_1,outputFileName1, Geno_file_, meta_mode, allele_file_1, pos, -1, gwas_file_, MAF, data_index2, nested, false,p_cutoff, cis_summary,cor_file_1, causal_1);
