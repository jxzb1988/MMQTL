             ...
             if(!test_only)
              {
               ...
               MM_conditional_analysis(y,gene, totalCausalSNP,rho, histFlag, gamma,weight, nthread,covariate_file_, grm_file_,outputFileName, Geno_file_, meta_mode, allele_file_, pos, colocal, gwas_file_, MAF, data_index, nested, finemap,p_cutoff, cis_summary,cor_file, causal, eQTL_number, Han);
