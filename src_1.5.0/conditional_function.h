...
int calculate_Mvalue(vector<vector<vector<double> > > &z_score_, vector<vector<vector<double> > > &beta_,  vector<vector<vector<double> > > &sd_, int index, string output, vector<vector<double> >  &variant, map<string,bool> &pos, map<string,bool> &pos1, map<int,bool> &data_index, double z_cutoff, bool cov);
...
int conditional_analysis(string file, string gene, int totalCausalSNP,float rho, bool histFlag, double gamma,string weight, int nthread,string covariate, string grm_file,string outputFile,string geno_file,vector<vector<double> > &z_score, vector<vector<double> > &beta, vector<vector<double> > &sd, int index, vector<string>  &variant, vector<string> &removal, int I, int colocalization, double &Variance, bool wald);
...
void ConstructCov(vector<vector<vector<double> > > &z_score, vector<vector<vector<double> > > &beta_, vector<vector<double> > &sd, int x, double z_cutoff, bool COV);
